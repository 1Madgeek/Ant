...
/**
 * Created by Madgeek Pvt Ltd on 19/07/18.
...
public class MultipartRequest extends Request<String> {
    ...
    MultipartRequest(String url, final Map<String, String> params, File imageFile, String filename, String fileFieldName, Response.ErrorListener errorListener, Response.Listener<String> listener){
